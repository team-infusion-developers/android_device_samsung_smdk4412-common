...
static int check_vendor_module()
{
    ...
    rv = hw_get_module_by_path("/system/vendor/lib/vendor-camera.smdk4x12.so", (const hw_module_t **)&gVendorModule);
    if (rv)
...
{
    int ret = 0;
    struct camera_device *camera_dev = NULL;
    ...
    camera_dev = (struct camera_device *)((hw_device_t*)wrapper_dev->vendor);
    ALOGE("camera_device_close: camera_dev->priv pointer is %p", camera_dev->priv);
